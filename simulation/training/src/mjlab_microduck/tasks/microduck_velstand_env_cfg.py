...
def make_microduck_velstand_env_cfg(
    play: bool = False,
    rough: bool = False,
    robot_cfg=MICRODUCK_STANDUP_ROBOT_CFG,
    reset_z=(0.12, 0.13),
    ...
    cfg = make_microduck_velocity_env_cfg(
        play=play, rough=rough, robot_cfg=robot_cfg, reset_z=reset_z,
        pose_exclude_extra=pose_exclude_extra, rough_terrains=rough_terrains,
        arm_pose_cmd=arm_pose_cmd, tail_pose_cmd=tail_pose_cmd,
        jaw_pose_cmd=jaw_pose_cmd, lin_vel_max=lin_vel_max,
        body_pose_weight=body_pose_weight,
        body_nominal_height=body_nominal_height,
        servo_dr=servo_dr,
        obs_delay=obs_delay,
        stand_still_weight=stand_still_weight,
        action_scale_dr=action_scale_dr,
        ang_vel_max=ang_vel_max,
        ang_track_weight=ang_track_weight,
    )
